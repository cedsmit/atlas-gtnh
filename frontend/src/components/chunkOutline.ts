...
export type ChunkOutlineState = 'queued' | 'rendering' | 'loaded' | 'empty' | 'tainted' | 'error'
...
export class ChunkOutlineOverlay {
  ...
  set(key: string, mcx: number, mcz: number, state: ChunkOutlineState, enabled: boolean): void {
