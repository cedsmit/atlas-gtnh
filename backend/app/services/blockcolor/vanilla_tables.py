...
_OVERRIDES: dict[str, str] = {
    ...
    # Chisel: meta-variant blocks under subdir paths (cubit/0, hempcrete/concrete/white)
    ...
    # Thaumcraft:blockCosmeticSolid — meta-variant decorative block; arcane_stone is representative
    "thaumcraft:blockcosmeticsolid": "thaumcraft:arcane_stone",
    # GregTech natural stone replacements — FML name uses dot-separated path, not snake_case
